            ...
            <div className="flex justify-between flex-wrap flex-col md:flex-row gap-[30px] mt-[30px]">
               <div className="flex items-start gap-[15px] w-[340px] max-w-full">
                  ...
                  <p className=" font-normal text-sm tracking-[0.8px] ">
                     ...
                     Harum nisi dignissimos unde ipsam modi facilis nam magni,
                     assumenda ad fuga.
                  </p>
               </div>
               <div>
               ...
               <ul className="grid grid-cols-1 md:grid-cols-2 gap-[20px]">
                  {links.map((item) => (
                     <li key={item}>
                        <a
                           to={item.toLowerCase()}
                           className=" hover:text-primary transition-all duration-200 text-base cursor-pointer"
                        >
                           {item}
                        </a>
                     </li>
               ...
               <ul className="flex gap-[15px] w-full justify-center md:w-auto">
                  {socialIcons.map((item) => (
                     <li key={item}>
                        <a to={item} className="group cursor-pointer">
